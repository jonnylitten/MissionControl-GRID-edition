...
***IMPORTANT: 
Atmosphère >= 1.11.1 is required to run the latest release of Mission Control on firmware 22.1.0+. Using an older Atmosphère version will cause Mission Control to crash or freeze the system on boot.***
